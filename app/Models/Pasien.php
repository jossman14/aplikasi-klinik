...
class Pasien extends Model
{
    ...
    protected $fillable = [
        "norm","nama", "alamat_tetap", "desa_tetap_id", "kecamatan_tetap_id", "kabupaten_tetap_id", "provinsi_tetap_id", "nama_keluarga", "nik", "tempat_lahir", "tgl_lahir", "jenis_kelamin", "agamaId", "alamat_sementara", "desa_smt_id", "kecamatan_smt_id", "kabupaten_smt_id", "provinsi_smt_id", "alamat_keluarga", "desa_klg_id", "kecamatan_klg_id", "kabupaten_klg_id", "provinsi_klg_id", "umur", "gol_dar_id", "tgl_reg", "pekerjaan", "nomor_telepon", "nomor_telepon_keluarga", "nomor_bpjs", "created_at", "updated_at", "deleted_at","sapaan",
    ];

    public function allData(){
        // $data = DB::table('pasien')->limit(5)->get();
        $data = DB::table("pasien")->select("pasien.id as pasienId", "pasien.norm", "pasien.nama", "pasien.tgl_lahir", "pasien.umur", "pasien.desa_tetap_id", "villages.id", "villages.name as nama_desa")->join("villages", "villages.id", "=", "pasien.desa_tetap_id")->where("deleted_at","=",null)->orderBy("pasien.tgl_reg","desc")->limit(10)->get();
