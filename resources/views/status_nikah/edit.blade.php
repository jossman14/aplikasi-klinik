...
Halaman Ubah Data Status Nikah
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Status Nikah</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Status Nikah</a>
                <a href="#!" class="breadcrumb">Ubah Data Status Nikah</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Status Nikah</h5>


                            <form action="{{ route('status_nikah.update',  $status_nikah->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $status_nikah->nama) }}" required>
                                    <label for="nama"> Status Nikah : <span class="danger"></span>
                                    </label>
                                </div>
