...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Manajemen Status Nikah</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Status Nikah</a>
                <a href="#!" class="breadcrumb">Manajemen Status Nikah</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="container-fluid">
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title">Data Status Nikah</h5>
                        <div class="row align-items-center">
                            ...
                            <div class="col s12 m4 l2 align-self-center">
                                <a class="waves-effect waves-light btn-small blue"
                                    href="{{ route('status_nikah.create') }}"><i
                                        class="material-icons left">add</i>Tambah Status Nikah</a>

                                <a class="waves-effect waves-light btn-small blue m-t-10 modal-trigger"
                                    href="#modal1"><i class="material-icons left">add</i>Filter Status Nikah</a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <a type="button"
                                                    ...
                                                    href="{{ route('status_nikah.edit', $item->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('status_nikah.destroy', $item->id) }}"
        ...
        <div id="modal1" class="modal p-20">
            <div class="modal-content">
                ...
                <div class="row">
                    <form class="col s12" id="cariData" action="{{ route('statusNikahFilter') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="icon_prefix" type="text" class="validate" name="nama">
                                <label for="icon_prefix">Status Nikah</label>
                            </div>
                        </div>
