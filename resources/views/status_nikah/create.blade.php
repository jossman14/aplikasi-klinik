...
Halaman Tambah Data Status Nikah
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Status Nikah</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Status Nikah</a>
                <a href="#!" class="breadcrumb">Tambah Data Status Nikah</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Status Nikah Baru</h5>

                            <form action="{{ route('status_nikah.store') }}"
