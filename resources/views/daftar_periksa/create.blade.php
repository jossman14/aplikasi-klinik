                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            ...
                            <form action="{{ route('daftar_periksa.store') }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="date" class="waktu_daftar_periksa" id="waktu_daftar_periksa" name="waktu_daftar_periksa" required>
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="id_pasien" id="id_pasien" value="{{$daftar_periksa->nama}}" name="id_pasien_fake" required disabled >
                                    <input type="text" class="id_pasien" id="id_pasien" value="{{$daftar_periksa->id}}" name="id_pasien" hidden >
                          ...
                          <div class="row">
                            <div class="col s12 m6">
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="cara_bayar" value="umum" id="cara_bayar" name="cara_bayar" required>
                                    <label for="cara_bayar"  > Cara Bayar : <span class="danger"></span>
                                    </label>
                                </div>

                                <div class="input-field col s12">
                                    <input type="text" class="rujukan" id="rujukan" name="rujukan" required value="tidak ada">
                                    <label for="rujukan"> Rujukan : <span class="danger"></span>
                                    </label>
                                </div>

                                <div class="input-field col s12">
                                    <input type="text" class="penanggungjawab" id="penanggungjawab" name="penanggungjawab" required value="pribadi">
