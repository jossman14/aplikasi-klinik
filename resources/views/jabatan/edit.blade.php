...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Jabatan</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jabatan</a>
                <a href="#!" class="breadcrumb">Ubah Data Jabatan</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Jabatan</h5>
                            ...
                            <form action="{{ route('jabatan.update',  $jabatan->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="jabatan"  value="{{ old('jabatan', $jabatan->nama) }}" required>
                                    <label for="jabatan"> Jabatan : <span class="danger"></span>
                                    </label>
                                </div>
