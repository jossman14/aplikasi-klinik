...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Jabatan</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jabatan</a>
                <a href="#!" class="breadcrumb">Tambah Data Jabatan</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Jabatan Baru</h5>
                            ...
                            <form action="{{ route('jabatan.store') }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="jabatan" required>
