...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Poliklinik</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Poliklinik</a>
                <a href="#!" class="breadcrumb">Ubah Data Poliklinik</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Poliklinik</h5>


                            <form action="{{ route('poliklinik.update',  $poliklinik->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $poliklinik->nama) }}" required>
                                    <label for="nama"> Poliklinik : <span class="danger"></span>
                                    </label>
                                </div>
