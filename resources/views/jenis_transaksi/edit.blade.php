...
Halaman Ubah Data Jenis Transaksi
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Jenis Transaksi</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Transaksi</a>
                <a href="#!" class="breadcrumb">Ubah Data Jenis Transaksi</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Jenis Transaksi</h5>


                            <form action="{{ route('jenis_transaksi.update',  $jenis_transaksi->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $jenis_transaksi->nama) }}" required>
                                    <label for="nama"> Jenis Transaksi : <span class="danger"></span>
                                    </label>
                                </div>
