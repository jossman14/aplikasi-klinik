...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Manajemen Jenis Transaksi</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Transaksi</a>
                <a href="#!" class="breadcrumb">Manajemen Jenis Transaksi</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="container-fluid">
                        ...
                        <div class="row align-items-center">
                            <div class="col s12 m8 l10">
                                <h6 class="card-subtitle">Detail data jenis transaksi pasien.
                                    ...
                                    @isset($filter_pencarian)
                                        <span> Tabel menampilkan hasil pencarian {{ count($jenis_transaksi) }} data dengan
                                            filter
                                            pencarian</span>
                            ...
                            <div class="col s12 m4 l2 align-self-center">
                                <a class="waves-effect waves-light btn-small blue"
                                    href="{{ route('jenis_transaksi.create') }}"><i
                                        class="material-icons left">add</i>Tambah Jenis Transaksi</a>

                                <a class="waves-effect waves-light btn-small blue m-t-10 modal-trigger"
                                    href="#modal1"><i class="material-icons left">add</i>Filter Jenis Transaksi</a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <a type="button"
                                                    ...
                                                    href="{{ route('jenis_transaksi.edit', $item->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('jenis_transaksi.destroy', $item->id) }}"
        ...
        <div id="modal1" class="modal p-20">
            <div class="modal-content">
                ...
                <div class="row">
                    <form class="col s12" id="cariData" action="{{ route('jenisTransaksiFilter') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="icon_prefix" type="text" class="validate" name="nama">
                                <label for="icon_prefix">Jenis Transaksi</label>
                            </div>
                        </div>
