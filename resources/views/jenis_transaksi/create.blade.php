...
Halaman Tambah Data Jenis Transaksi
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Jenis Transaksi</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Transaksi</a>
                <a href="#!" class="breadcrumb">Tambah Data Jenis Transaksi</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Jenis Transaksi Baru</h5>

                            <form action="{{ route('jenis_transaksi.store') }}"
