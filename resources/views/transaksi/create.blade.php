...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Tindakan</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Tindakan</a>
                <a href="#!" class="breadcrumb">Tambah Data Tindakan</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                    ...
                    <div>
                        <div class="card-content">
                            ...
                            <form action="{{ route('tindakan.store') }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="number" class="alat" id="alat" name="alat" required value="0">
                                    <label for="alat"> Alat : <span class="danger"></span>
                                    </label>
                                </div>
                                <div class="input-field col s12">
                                    <input type="number" class="bahan" id="bahan" name="bahan" required value="0">
                                    <label for="bahan"> Bahan : <span class="danger"></span>
                                    </label>
                                </div>
                                <div class="input-field col s12">
                                    <input type="number" class="lainnya" id="lainnya" name="lainnya" required value="0">
