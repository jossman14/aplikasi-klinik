...
<div class="page-wrapper page-header">
    ...
    <div class="card info-gradient m-t-0 m-b-0">
        <div class="card-content">
            <div class="p-b-40 p-t-20">
                <h3 class="white-text">Welcome back Jossman!</h3>
    ...
    <div class="container-fluid">
                    ...
                    <div class="col s12 m6 l6">
                        <div class="card warning-gradient card-hover">
                            <div class="card-content">
                                ...
                                <p class="m-b-5"><span class="white-text op-5">This Month <span
                                            class="right">$250</span></span></p>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex no-block align-items-center">
                                                <div class="m-r-10"><img
                                                        src="{{ asset('template') }}/assets/images/users/d1.jpg"
                                        ...
                                        <td>
                                            <div class="popover-icon">
                                                ...
                                                <a class="btn-floating btn white"><img
                                                        src="{{ asset('template') }}/assets/images/users/1.jpg"
                                                        class="circle" width="41" /></a>
                                                <a
                                                    class="btn-floating btn light-blue lighten-5 blue-text text-darken-1">+</a>
                                            </div>
                                        </td>
                                        <td><i class="fa fa-circle orange-text tooltipped"
                                                data-tooltip="In Progress"></i></td>
                                        <td>35</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex no-block align-items-center">
                                                <div class="m-r-10"><img
                                                        src="{{ asset('template') }}/assets/images/users/d2.jpg"
                                                        alt="user" class="circle" width="45" /></div>
                                                <div class="">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex no-block align-items-center">
                                                <div class="m-r-10"><img
                                                        src="{{ asset('template') }}/assets/images/users/d3.jpg"
                                                        alt="user" class="circle" width="45" /></div>
                                                <div class="">
        ...
        <div class="row">
            ...
            <div class="col l4">
                <div class="card">
                    <img class="card-img-top responsive-img" src="{{ asset('template') }}/assets/images/big/img4.jpg"
                        alt="Card image cap">
                    <div class="card-content">
                        <div class="d-flex no-block align-items-center m-b-15">
                            <span><i class="ti-calendar"></i> 20 May 2018</span>
                            <div class="ml-auto">
                                <a href="javascript:void(0)" class="link"><i class="ti-comments"></i> 3
                                    Comments</a>
                            </div>
                        </div>
                        <h5>Featured Hydroflora Pots Garden &amp; Outdoors</h5>
                        <p class="m-b-0 m-t-10">Titudin venenatis ipsum ac feugiat. Vestibulum ullamcorper quam.
                        </p>
            ...
            <div class="col l4">
                <div class="card">
                    <img class="card-img-top responsive-img" src="{{ asset('template') }}/assets/images/big/img5.jpg"
                        alt="Card image cap">
                    <div class="card-content">
                        <div class="d-flex no-block align-items-center m-b-15">
                            <span><i class="ti-calendar"></i> 19 May 2018</span>
                            <div class="ml-auto">
                                <a href="javascript:void(0)" class="link"><i class="ti-comments"></i> 5
                                    Comments</a>
                            </div>
                        </div>
                        <h5>Featured Hydroflora Pots Garden &amp; Outdoors</h5>
            ...
            <div class="col l4">
                <div class="card">
                    <img class="card-img-top responsive-img" src="{{ asset('template') }}/assets/images/big/img6.jpg"
                        alt="Card image cap">
                    <div class="card-content">
                        <div class="d-flex no-block align-items-center m-b-15">
                            <span><i class="ti-calendar"></i> 29 May 2018</span>
                            <div class="ml-auto">
                                <a href="javascript:void(0)" class="link"><i class="ti-comments"></i> 6
                                    Comments</a>
                            </div>
                        </div>
                        <h5>Featured Hydroflora Pots Garden &amp; Outdoors</h5>
