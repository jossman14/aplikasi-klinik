...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center"
            style="background:url({{ asset('template') }}/assets/images/big/bg_auth.jpg) no-repeat center center; background-size: cover; background-color: #2c3e50;   background-blend-mode: lighten;">
            <div class="auth-box">
                <div id="loginform">
                    <div class="logo">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input id="password" type="password"
                                        class="validate form-control @error('password') is-invalid @enderror"
