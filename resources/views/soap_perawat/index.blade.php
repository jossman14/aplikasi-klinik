...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Manajemen Soap Perawat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Soap Perawat</a>
                <a href="#!" class="breadcrumb">Manajemen Soap Perawat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title">Data Soap Perawat</h5>
