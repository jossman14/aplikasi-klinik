...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Satuan Obat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Satuan Obat</a>
                <a href="#!" class="breadcrumb">Ubah Data Satuan Obat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Satuan Obat</h5>


                            <form action="{{ route('satuan_obat.update',  $satuan_obat->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $satuan_obat->nama) }}" required>
                                    <label for="nama"> Satuan Obat : <span class="danger"></span>
                                    </label>
                                </div>
