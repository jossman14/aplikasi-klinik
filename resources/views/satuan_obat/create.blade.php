...
Halaman Tambah Data Satuan Obat
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Satuan Obat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Satuan Obat</a>
                <a href="#!" class="breadcrumb">Tambah Data Satuan Obat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Satuan Obat Baru</h5>

                            <form action="{{ route('satuan_obat.store') }}"
