...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Manajemen Jenis Tindakan</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Tindakan</a>
                <a href="#!" class="breadcrumb">Manajemen Jenis Tindakan</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="container-fluid">
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title">Data Jenis Tindakan</h5>
                        <div class="row align-items-center">
                            <div class="col s12 m8 l10">
                                <h6 class="card-subtitle">Detail data jenis tindakan pasien.



                                    @isset($filter_pencarian)
                                        <span> Tabel menampilkan hasil pencarian {{ count($jenis_tindakan) }} data dengan
                                            filter
                                            pencarian</span>
                            ...
                            <div class="col s12 m4 l2 align-self-center">
                                <a class="waves-effect waves-light btn-small blue"
                                    href="{{ route('jenis_tindakan.create') }}"><i
                                        class="material-icons left">add</i>Tambah Jenis Tindakan</a>

                                <a class="waves-effect waves-light btn-small blue m-t-10 modal-trigger"
                                    href="#modal1"><i class="material-icons left">add</i>Filter Jenis Tindakan</a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <a type="button"
                                                    ...
                                                    href="{{ route('jenis_tindakan.edit', $item->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('jenis_tindakan.destroy', $item->id) }}"
        ...
        <div id="modal1" class="modal p-20">
            <div class="modal-content">
                ...
                <div class="row">
                    <form class="col s12" id="cariData" action="{{ route('jenisTindakanFilter') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="icon_prefix" type="text" class="validate" name="nama">
                                <label for="icon_prefix">Jenis Tindakan</label>
                            </div>
                        </div>
