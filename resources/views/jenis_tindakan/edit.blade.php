...
Halaman Ubah Data Jenis Tindakan
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Jenis Tindakan</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Tindakan</a>
                <a href="#!" class="breadcrumb">Ubah Data Jenis Tindakan</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Jenis Tindakan</h5>


                            <form action="{{ route('jenis_tindakan.update',  $jenis_tindakan->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $jenis_tindakan->nama) }}" required>
