...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Sapaan</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Sapaan</a>
                <a href="#!" class="breadcrumb">Tambah Data Sapaan</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Sapaan Baru</h5>

                            <form action="{{ route('sapaan.store') }}"
                                class="validation-wizard wizard-circle m-t-40" method="POST" id="sapaan_form">
                                @csrf


                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="sapaan" required>
