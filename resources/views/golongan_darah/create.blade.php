...
Halaman Tambah Data Golongan Darah
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Golongan Darah</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Golongan Darah</a>
                <a href="#!" class="breadcrumb">Tambah Data Golongan Darah</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Golongan Darah Baru</h5>

                            <form action="{{ route('golongan_darah.store') }}"
                                class="validation-wizard wizard-circle m-t-40" method="POST" id="golongan_darah_form">
                                @csrf


                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="golongan_darah" required>
