...
Halaman Ubah Data Golongan Darah
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Golongan Darah</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Golongan Darah</a>
                <a href="#!" class="breadcrumb">Ubah Data Golongan Darah</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Golongan Darah</h5>


                            <form action="{{ route('golongan_darah.update',  $golongan_darah->gol_dar_id) }}"
                                class="validation-wizard wizard-circle m-t-40" method="POST" id="golongan_darah_form">
                                @csrf
                                @method('PUT')


                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="golongan_darah"  value="{{ old('golongan_darah', $golongan_darah->golongan_darah) }}" required>
                                    <label for="golongan_darah"> Golongan Darah : <span class="danger"></span>
                                    </label>
                                </div>
