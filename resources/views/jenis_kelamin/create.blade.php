...
Halaman Tambah Data Jenis Kelamin
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Jenis Kelamin</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Kelamin</a>
                <a href="#!" class="breadcrumb">Tambah Data Jenis Kelamin</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Jenis Kelamin Baru</h5>

                            <form action="{{ route('jenis_kelamin.store') }}"
                                class="validation-wizard wizard-circle m-t-40" method="POST" id="jenis_kelamin_form">
                                @csrf


                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="jenis_kelamin" required>
