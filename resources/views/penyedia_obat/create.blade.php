...
Halaman Tambah Data Penyedia Obat
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Penyedia Obat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Penyedia Obat</a>
                <a href="#!" class="breadcrumb">Tambah Data Penyedia Obat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Penyedia Obat Baru</h5>

                            <form action="{{ route('penyedia_obat.store') }}"
