...
Halaman Ubah Data Penyedia Obat
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Penyedia Obat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Penyedia Obat</a>
                <a href="#!" class="breadcrumb">Ubah Data Penyedia Obat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Penyedia Obat</h5>


                            <form action="{{ route('penyedia_obat.update',  $penyedia_obat->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $penyedia_obat->nama) }}" required>
                                    <label for="nama"> Penyedia Obat : <span class="danger"></span>
                                    </label>
                                </div>
