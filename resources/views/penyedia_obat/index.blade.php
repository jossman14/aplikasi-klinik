...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Manajemen Penyedia Obat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Penyedia Obat</a>
                <a href="#!" class="breadcrumb">Manajemen Penyedia Obat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="container-fluid">
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title">Data Penyedia Obat</h5>
                        <div class="row align-items-center">
                            <div class="col s12 m8 l10">
                                <h6 class="card-subtitle">Detail data jenis transaksi pasien.
                                    ...
                                    @isset($filter_pencarian)
                                        <span> Tabel menampilkan hasil pencarian {{ count($penyedia_obat) }} data dengan
                                            filter
                                            pencarian</span>
                            ...
                            <div class="col s12 m4 l2 align-self-center">
                                <a class="waves-effect waves-light btn-small blue"
                                    href="{{ route('penyedia_obat.create') }}"><i
                                        class="material-icons left">add</i>Tambah Penyedia Obat</a>

                                <a class="waves-effect waves-light btn-small blue m-t-10 modal-trigger"
                                    href="#modal1"><i class="material-icons left">add</i>Filter Penyedia Obat</a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <a type="button"
                                                    ...
                                                    href="{{ route('penyedia_obat.edit', $item->id) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('penyedia_obat.destroy', $item->id) }}"
        ...
        <div id="modal1" class="modal p-20">
            <div class="modal-content">
                ...
                <div class="row">
                    <form class="col s12" id="cariData" action="{{ route('penyediaObatFilter') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="icon_prefix" type="text" class="validate" name="nama">
                                <label for="icon_prefix">Penyedia Obat</label>
                            </div>
                        </div>
