...
Halaman Ubah Data Pengeluaran Berulang
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Pengeluaran Berulang</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Pengeluaran Berulang</a>
                <a href="#!" class="breadcrumb">Ubah Data Pengeluaran Berulang</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Pengeluaran Berulang</h5>


                            <form action="{{ route('pengeluaran_berulang.update',  $pengeluaran_berulang->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $pengeluaran_berulang->nama) }}" required>
                                    <label for="nama"> Pengeluaran Berulang : <span class="danger"></span>
                                    </label>
                                </div>
