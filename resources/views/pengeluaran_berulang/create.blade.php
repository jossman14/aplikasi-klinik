...
Halaman Tambah Data Pengeluaran Berulang
@endsection
...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Pengeluaran Berulang</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Pengeluaran Berulang</a>
                <a href="#!" class="breadcrumb">Tambah Data Pengeluaran Berulang</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Pengeluaran Berulang Baru</h5>

                            <form action="{{ route('pengeluaran_berulang.store') }}"
