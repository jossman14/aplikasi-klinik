...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Jenis Obat</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Jenis Obat</a>
                <a href="#!" class="breadcrumb">Ubah Data Jenis Obat</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Jenis Obat</h5>


                            <form action="{{ route('jenis_obat.update',  $jenis_obat->id) }}"
                                ...
                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="nama"  value="{{ old('nama', $jenis_obat->nama) }}" required>
                                    <label for="nama"> Jenis Obat : <span class="danger"></span>
                                    </label>
                                </div>
