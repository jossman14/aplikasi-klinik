...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Obat Detail</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Obat Detail</a>
                <a href="#!" class="breadcrumb">Tambah Obat Detail</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content wizard-content">
                        ...
                        <form action="{{ route('obat_detail.store') }}"
                            ...
                            <section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="number" class="min_stock" id="min_stock" name="min_stock">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="number" class="max_stock" id="max_stock" name="max_stock">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="number" class="stock" id="stock" name="stock">
                                ...
                                <div class="row">
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="date" class="tgl_beli" id="tgl_beli" name="tgl_beli">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="date" class="expire" id="expire" name="expire">
                            ...
                            <section>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="text" class="batch" id="batch" name="batch">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="number" class="harga_beli" id="harga_beli" name="harga_beli">
                                    ...
                                    <div class="col m6">
                                        <div class="input-field col s12">
                                            <input type="number" class="harga_jual" id="harga_jual" name="harga_jual">
