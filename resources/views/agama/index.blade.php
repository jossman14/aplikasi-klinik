...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Manajemen Agama</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Agama</a>
                <a href="#!" class="breadcrumb">Manajemen Agama</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
    ...
    <div class="container-fluid">
                    ...
                    <div class="card-content">
                        ...
                        <div class="row align-items-center">
                            <div class="col s12 m8 l10">
                                <h6 class="card-subtitle">Detail data agama pasien.



                                    @isset($filter_pencarian)
                                        <span> Tabel menampilkan hasil pencarian {{ count($agama) }} data dengan filter
                                            pencarian</span>
                            ...
                            <div class="col s12 m4 l2 align-self-center">
                                <a class="waves-effect waves-light btn-small blue"
                                    href="{{ route('agama.create') }}"><i
                                        class="material-icons left">add</i>Tambah Agama</a>

                                <a class="waves-effect waves-light btn-small blue m-t-10 modal-trigger"
                                    href="#modal1"><i class="material-icons left">add</i>Filter Agama</a>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <a type="button"
                                                    ...
                                                    href="{{ route('agama.edit', $item->agamaId) }}"
                                                ...
                                                <form method="POST"
                                                    action="{{ route('agama.destroy', $item->agamaId) }}"
        ...
        <div id="modal1" class="modal p-20">
            <div class="modal-content">
                ...
                <div class="row">
                    <form class="col s12" id="cariData" action="{{ route('agamaFilter') }}"
                        method="POST">
                        @csrf
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="icon_prefix" type="text" class="validate"  name="nama">
                                <label for="icon_prefix">Agama</label>
                            </div>
                        </div>
