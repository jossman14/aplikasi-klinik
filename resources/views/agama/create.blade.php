...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Tambah Data Agama</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Agama</a>
                <a href="#!" class="breadcrumb">Tambah Data Agama</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Agama Baru</h5>

                            <form action="{{ route('agama.store') }}"
                                class="validation-wizard wizard-circle m-t-40" method="POST" id="agama_form">
                                @csrf


                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="agama" required>
