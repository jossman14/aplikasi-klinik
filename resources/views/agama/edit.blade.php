...
<div class="page-wrapper">
    ...
    <div class="page-titles">
        <div class="d-flex align-items-center">
            <h5 class="font-medium m-b-0">Ubah Data Agama</h5>
            <div class="custom-breadcrumb ml-auto">
                <a href="#!" class="breadcrumb">Agama</a>
                <a href="#!" class="breadcrumb">Ubah Data Agama</a>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="col s12">
                    <div>
                        <div class="card-content">
                            <h5 class="card-title">Form Ubah Data Agama</h5>


                            <form action="{{ route('agama.update',  $agama->agamaId) }}"
                                class="validation-wizard wizard-circle m-t-40" method="POST" id="agama_form">
                                @csrf
                                @method('PUT')


                                <div class="input-field col s12">
                                    <input type="text" class="nama" id="nama" name="agama"  value="{{ old('agama', $agama->agama) }}" required>
                                    <label for="agama"> Agama : <span class="danger"></span>
                                    </label>
                                </div>
